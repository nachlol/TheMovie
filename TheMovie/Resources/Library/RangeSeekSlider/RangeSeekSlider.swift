...
@IBDesignable open class RangeSeekSlider: UIControl {
    ...
    open override func beginTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
        ...
        let insetExpansion: CGFloat = -3.0
        ...
        var isTouchingLeftAndRightHandle = false
        
        if (isTouchingLeftHandle == true && isTouchingRightHandle == true) {
        
            isTouchingLeftAndRightHandle = true
        }
        
        if (isTouchingLeftHandle == true) {
            
            print("isTouchingLeftHandle")
        }
        
        if (isTouchingRightHandle == true) {
            
            print("isTouchingRightHandle")
        }
        ...
        if (distanceFromLeftHandle < distanceFromRightHandle && !disableRange) {
            ...
            if (isTouchingLeftAndRightHandle == true) {
                
                if (leftHandle.zPosition > rightHandle.zPosition) {
                    handleTracking = .left
                } else {
        ...
        if (handleTracking == .left) {
            ...
            leftHandle.zPosition = 2
            rightHandle.zPosition = 1
            
        } else {
        
            leftHandle.zPosition = 1
            rightHandle.zPosition = 2
        }
